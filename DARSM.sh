...
if [ -z "$sample_name" ] || [ -z "$input_format" ] || [ -z "$tumor_input" ] || [ -z "$normal_input" ] || [ -z "$out_prefix" ] || [ -z "$thread" ] || [ -z "$ram" ] || [ -z "$gatk" ] || [ -z "$picard" ] || [ -z "$samtools" ] || [ -z "$hisat2" ] || [ -z "$fasta_ref" ] || [ -z "$gtf_ref" ] || [ -z "$genelist_ref" ] || [ -z "$dbsnp_ref" ] || [ -z "$germline_ref" ] || [ -z "$PON_ref" ] || [ -z "$hisat_ref" ] || [ -z "$igg_ref" ] || [ -z "$hla_ref" ] || [ -z "$pseudo_ref" ] || [ -z "$tcga_PON_ref" ] || [ -z "$radar_ref" ] || [ -z "$darned_ref" ] || [ -z "$REDI_ref" ]; then
